...
def move(url,headers,move,turn):
    ...
    move_object["actions"][0]["agentID"] = 2
    move_object["actions"][0]["apply"] = 1
    move_object["actions"][0]["dx"] = move[0]
    move_object["actions"][0]["dy"] = move[1]
    move_object["actions"][0]["turn"] = turn
    print(move_object)
    response = requests.post(url+"/procon/team2/move",json = move_object)
